...
const xScale = d3.scaleLinear()
  ...
  .range([spacing, width - spacing - 150]);

const yScale = d3.scaleTime()
  .domain(d3.extent(data, (d) => { return new Date("2000-01-01T00:" + d.Time); }))
  .range([height - spacing, 85]);
...
svg.append("g")
  ...
  .attr("cy", (d) => { return yScale(new Date("2000-01-01T00:" + d.Time)); })
  .attr("r", 5)
  .style("fill", (d) => {
    return d.Doping ? "rgba(255, 0, 0, 0.4)" : "rgba(0, 255, 0, 0.5)";
  })
  .attr("data-xvalue", (d) => { return d.Year; })
  .attr("data-yvalue", (d) => { return new Date("2000-01-01T00:" + d.Time); })
